...
delete p3_ptr;      // Freeing up the allocated memory, Calling Destructor and Copying Class Object Pointer to Destructor Parameter this

vector<Person> vec_name{} ;
vec_name.push_back(p1);
vec_name.push_back(p2);

vec_name.push_back(Person(10));   // This statement will be calling move constructor instead of copy constructor
